---
description: Set up the personal development harness for the current repository. Use when asked to set up, initialize, configure, or teach the harness about this repo.
---

Initialize the harness without requiring the user to edit configuration files.
...
3. Store the discovered repository profile with `harness-memory configure-repo --cwd "$PWD"` and the selected commands/paths.
